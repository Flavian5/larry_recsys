...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Benchmark conflation speed with different sample sizes")
    p.add_argument(
        "--sample-sizes",
        type=str,
        default="10000",
...
def main() -> int:
    ...
    print("SUMMARY")
    print(f"{'='*80}")
    print(f"{'Sample Size':>12} | {'Overture':>10} | {'Silver':>10} | {'Gold':>10} | {'Total':>10}")
    print("-" * 80)
